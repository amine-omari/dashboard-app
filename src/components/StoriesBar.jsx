...
const StoriesBar = () => {
  ...
  return (
    <div className="overflow-auto whitespace-nowrap scrollbar-thin scroll scrollbar-thumb-gray-700/30 flex gap-x-6 items-center px-5 min-h-[115px] border-b border-gray-700/60">
