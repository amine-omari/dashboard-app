...
const StoriesBar = () => {
  ...
  return (
    <div className="overflow-scroll whitespace-nowrap scrollbar-thin scroll scrollbar-thumb-gray-700/30 flex gap-x-6 items-center px-5 h-[150px] border-b border-gray-700/60">
