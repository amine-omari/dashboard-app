...
const MessagePreview = ({
  ...
  return (
    <button className="p-5 flex items-center 2xl:justify-between space-x-3 w-full border-b border-gray-700/60 hover:bg-gray-700/50">
      <div className="flex">
      ...
      <div className="flex flex-col items-start">
        ...
        <p className="text-gray-500 text-sm text-left truncate w-[230px]">
          {lastMessage}
        </p>
      </div>
