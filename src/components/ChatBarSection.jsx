          ...
          <div className="flex gap-x-3">
            ...
            <div>
              ...
              <p className="text-gray-500">
                Hello! Today we could like to present concept of the store with
                aerodynamic parts for the cars. Each items is fully customizable
                to give performance and soul to your dream car...
              </p>
              <img
